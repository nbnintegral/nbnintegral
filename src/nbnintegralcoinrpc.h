...
#ifndef _nbnintegralRPC_H_
#define _nbnintegralRPC_H_ 1
...
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // nbnintegral is not connected
...
/**
 * nbnintegral RPC command dispatcher.
 */
class CRPCTable
{
private:
