...
class TxViewDelegate : public QAbstractItemDelegate
{
    Q_OBJECT
public:
    TxViewDelegate(): QAbstractItemDelegate(), unit(nbnintegralUnits::BTC)
    {
                      ...
                      const QModelIndex &index ) const
    {
        ...
        painter->setPen(foreground);
        QString amountText = nbnintegralUnits::formatWithUnit(unit, amount, true);
        if(!confirmed)
        {
...
void OverviewPage::setBalance(qint64 balance, qint64 stake, qint64 unconfirmedBalance, qint64 immatureBalance)
{
    ...
    //ui->labelStake->setText(nbnintegralUnits::formatWithUnit(unit, stake));
    ui->labelUnconfirmed->setText(nbnintegralUnits::formatWithUnit(unit, unconfirmedBalance));
    ui->labelImmature->setText(nbnintegralUnits::formatWithUnit(unit, immatureBalance));
